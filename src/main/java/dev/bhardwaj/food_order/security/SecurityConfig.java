	 ...
	 @Bean
	    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
         ...
         .authorizeHttpRequests((authorize) -> authorize
        	 .requestMatchers("/api/customer/create",
        			 "api/customer/login").permitAll()
        	 
        	 .requestMatchers("/api/dish/get-dish-details/**",
        			 "api/dish/get-dishes-from-restaurant-by-cuisine/**",
        			 "api/dish/get-dishes-by-cuisine/**",
        			 "api/dish/get-dishes-based-on-rating").permitAll()
        	 
        	 .requestMatchers("/api/restaurant/get-restaurant-details/**").permitAll()
        	 
             .requestMatchers("/api/customer/update",
            		 "/api/customer/delete/**",
            		 "/api/customer/get-customer-details/**").hasAuthority("NORMAL_USER")
             ...
             .requestMatchers("/api/review/add-review",
            		 "/api/review/get-reviews-given-by-customer/**").hasAuthority("NORMAL_USER")
             ...
             .requestMatchers("/api/restaurant/create",
            		 "/api/restaurant/delete/**",
            		 "/api/restaurant/open/**",
            		 "/api/restaurant/close/**").hasAuthority("ADMIN_USER")
